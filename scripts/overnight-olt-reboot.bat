...
timeout 3 > NUL
call newman run full-collection6 --folder=OLT_REBOOT -e ENV6 -g GLB6 -k --export-environment ENV6
timeout 1200 > NUL
call newman run full-collection6 --folder=GET_SESSION_ID -e ENV6 -g GLB6 -k --export-environment ENV6
timeout 3 > NUL
call newman run full-collection6 --folder=SUBSCRIBE_KPI -e ENV6 -g GLB6 -k --export-environment ENV6 -d SUBSCRIBE_KPI.json
timeout 30 > NUL
call newman run full-collection6 --folder=GET_KPI -e ENV6 -g GLB6 -k --export-environment ENV6 -d SUBSCRIBE_KPI.json -r htmlextra --reporter-htmlextra-omitHeaders --reporter-htmlextra-export C:\reliability_test_logs\olt-reboot\report_before_%%n.html
timeout 10 > NUL
